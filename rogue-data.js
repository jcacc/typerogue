...
window.ROGUE_DATA = {
  ...
  classes: {
    ...
    ranger: {
      ...
      startSpell: null, passive: 'word_mastery',
      desc: 'Word Mastery: words 6+ characters deal 1.75× damage.',
      color: '#55efc4', icon: '🏹', unlocks: 'necromancer',
    },
    necromancer: {
      id: 'necromancer', name: 'NECROMANCER', hp: 75, dmgMult: 1.2, wordSpeedMult: 1.1,
      startSpell: 'drain', passive: 'dark_absorb',
      desc: 'Dark Absorb: destroying a red word heals 6 HP and deals 2× damage.',
      color: '#a29bfe', icon: '💀', unlocks: null,
    },
  },
  ...
  upgrades: [
    ...
    // Gear (shop-exclusive)
    { id:'gear_gauntlets', name:'IRON GAUNTLETS', type:'gear', rarity:'rare',
      desc:'+0.5 damage multiplier', price:85, effect:{ dmgMult:0.5 } },
    { id:'gear_mail',      name:'CHAIN MAIL',     type:'gear', rarity:'rare',
      desc:'+50 max HP  ·  heal 25 now', price:90, effect:{ maxHpBonus:50, healNow:25 } },
    { id:'gear_axe',       name:'WAR AXE',        type:'gear', rarity:'epic',
      desc:'Below 40% HP: ×2.0 damage (stacks with Berserker)', price:110, effect:{ warAxe:true } },
    { id:'gear_shield',    name:'OBSIDIAN SHIELD', type:'gear', rarity:'rare',
      desc:'Start each combat with 40 shield', price:95, effect:{ combatShield:40 } },
    { id:'gear_boots',     name:'SWIFTBOOTS',     type:'gear', rarity:'uncommon',
      desc:'Enemy words move 20% slower', price:80, effect:{ wordSpeedMult:0.80 } },
    { id:'gear_tome',      name:'ARCANE TOME',    type:'gear', rarity:'epic',
      desc:'Spell cooldowns reduced by 25%', price:110, effect:{ spellCDMult:0.75 } },
    { id:'gear_amulet',    name:'AMULET OF REGEN', type:'gear', rarity:'rare',
      desc:'Heal 25 HP when entering each room', price:90, effect:{ regenPerRoom:25 } },
    { id:'gear_blade',     name:'VAMPIRIC EDGE',  type:'gear', rarity:'epic',
      desc:'Heal 4 HP per word destroyed', price:100, effect:{ vampiricEdge:true } },
    // Deck
